...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        characterRoster.add(new Character("Althalaus",
                ...
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(0),timeSlots.get(3),timeSlots.get(5),timeSlots.get(7),
                        timeSlots.get(8), timeSlots.get(11),timeSlots.get(12),timeSlots.get(13),timeSlots.get(14)))));
        ...
        characterRoster.add(new Character("Elsten",
                new ArrayList<Job>(Arrays.asList(Job.PLD,Job.RDM,Job.SMN,Job.MCH)),
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(7),timeSlots.get(8),timeSlots.get(10),timeSlots.get(11)
                        ,timeSlots.get(13)))));

        characterRoster.add(new Character("Gatsin",
                new ArrayList<Job>(Arrays.asList(Job.MNK, Job.AST, Job.SMN, Job.PLD, Job.MCH)),
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(2), timeSlots.get(3),timeSlots.get(4),timeSlots.get(5),
                        timeSlots.get(7), timeSlots.get(8),timeSlots.get(9),timeSlots.get(10)))));

        characterRoster.add(new Character("Grym",
                new ArrayList<Job>(Arrays.asList(Job.SCH, Job.MCH)),
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(0), timeSlots.get(2),timeSlots.get(3),timeSlots.get(4),
                        timeSlots.get(5),timeSlots.get(6),timeSlots.get(7),timeSlots.get(8),timeSlots.get(10), timeSlots.get(11),
        ...
        characterRoster.add(new Character("Kuma",
                ...
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(0),timeSlots.get(3),timeSlots.get(7),timeSlots.get(8),
                        timeSlots.get(9),timeSlots.get(11)))));

        characterRoster.add(new Character("Lena",
                new ArrayList<Job>(Arrays.asList(Job.GNB,Job.BRD)),
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(0),timeSlots.get(2),timeSlots.get(3),timeSlots.get(4),
                        timeSlots.get(5),timeSlots.get(8),timeSlots.get(11),timeSlots.get(12),timeSlots.get(14)))));

        characterRoster.add(new Character("Mijin",
                new ArrayList<Job>(Arrays.asList(Job.MNK,Job.RDM)),
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(0),timeSlots.get(1),timeSlots.get(2),timeSlots.get(4),
                        timeSlots.get(9),timeSlots.get(10)))));

        characterRoster.add(new Character("Squishy",
                new ArrayList<Job>(Arrays.asList(Job.WAR)),
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(6),timeSlots.get(9),timeSlots.get(10),timeSlots.get(12),
                        timeSlots.get(13)))));

        characterRoster.add(new Character("Taei",
                new ArrayList<Job>(Arrays.asList(Job.DRK, Job.WAR, Job.SAM)),
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(0),timeSlots.get(5),timeSlots.get(7),timeSlots.get(8),
                        timeSlots.get(9),timeSlots.get(10),timeSlots.get(11),timeSlots.get(12),timeSlots.get(13),timeSlots.get(14)))));
        ...
        characterRoster.add(new Character("Yuma",
                ...
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(0),timeSlots.get(2),timeSlots.get(3),timeSlots.get(4),
                        timeSlots.get(5),timeSlots.get(7),timeSlots.get(8),timeSlots.get(11),timeSlots.get(12)))));

        characterRoster.add(new Character("Zan",
                new ArrayList<Job>(Arrays.asList(Job.RPR)),
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(0),timeSlots.get(3),timeSlots.get(5),timeSlots.get(7),
                        timeSlots.get(7),timeSlots.get(8),timeSlots.get(9),timeSlots.get(13),timeSlots.get(14)))));

        characterRoster.add(new Character("Zelfie",
                new ArrayList<Job>(Arrays.asList(Job.NIN, Job.SGE)),
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(6), timeSlots.get(7),timeSlots.get(9),timeSlots.get(10),
                        timeSlots.get(12)))));

        characterRoster.add(new Character("Firae",
                new ArrayList<Job>(Arrays.asList(Job.SAM)),
                new ArrayList<TimeSlot>(Arrays.asList(timeSlots.get(0),timeSlots.get(3),timeSlots.get(5),timeSlots.get(7),
                        timeSlots.get(8),timeSlots.get(9),timeSlots.get(11),timeSlots.get(14)))));
